...
time_t round(double_t a) { // double_t --> integer
	if (a.e < -3) {
...
//Compute scenario 1 for the given reactant
...
//Compute scenario 2 (or 3: the formula is the same) for the given reactants
...
double_t int_to_double_t(int a) { //Used to translate an activity level into double_t.
	double_t r;
	if (a < 10) {
		r.b = a * 1000;
		r.e = -3;
...
time_t T;
clock c;
double_t rate_; //"rate" is a reserved word

void update() {
	double_t // B --> A
	       R1_R0_rate = scenario2_3(k_R1_R0, int_to_double_t(R0), int_to_double_t(R0Levels), true, int_to_double_t(R1), int_to_double_t(R1Levels), true),
	       // C --> A
	       R2_R0_rate = scenario2_3(k_R2_R0, int_to_double_t(R0), int_to_double_t(R0Levels), false, int_to_double_t(R2), int_to_double_t(R2Levels), true),
	       // D --| A
	       R3_R0_rate = scenario2_3(k_R3_R0, int_to_double_t(R0), int_to_double_t(R0Levels), true, int_to_double_t(R3), int_to_double_t(R3Levels), true);
	rate_ = subtract(add(R1_R0_rate, R2_R0_rate), R3_R0_rate);
	if (rate_.b < 0) {
		delta = -1;
		rate_.b = -rate_.b;
	} else {
